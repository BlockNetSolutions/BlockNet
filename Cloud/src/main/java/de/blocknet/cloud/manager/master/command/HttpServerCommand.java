        ...
        if(args.length > 0){
            switch (args[0].toLowerCase()){
                ...
                case "stop":
                    ...
                    break;
                default:
                    Main.getLogger().info(MessageStyler.getFormattedString("§1Wrong usage! use §3" + getName() + "§1 <§3start§1/§3stop§1/§3restart§1>"));
                    break;
            }
        }else{
            Main.getLogger().info(MessageStyler.getFormattedString("§1No arguments given! use §3" + getName() + "§1 <§3start§1/§3stop§1/§3restart§1>"));
        }
    }
